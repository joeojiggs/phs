...
<form role="form" name="assign"  method="POST" >
    <div class="form-group" > 
        ...
        <select name="sub_id"class="form-control me"  style = "width:200px; margin:4px;"required >
           ...
           <?php 
             $query= mysqli_query($con2,"select * from basic3_subject_list where subject_id = 'subject1'");
             if (mysqli_num_rows($query) == 0) {
            ?>
            <option value="subject1">subject1</option>
            <?php
             } 
             $query= mysqli_query($con2,"select * from basic3_subject_list where subject_id = 'subject2'");
             if (mysqli_num_rows($query) == 0) {
            ?>
            <option value="subject2">subject2</option>
             <?php
             } 
             $query= mysqli_query($con2,"select * from basic3_subject_list where subject_id = 'subject3'");
             if (mysqli_num_rows($query) == 0) {
            ?>
            <option value="subject3">subject3</option>
             <?php
             } 
             $query= mysqli_query($con2,"select * from basic3_subject_list where subject_id = 'subject4'");
             if (mysqli_num_rows($query) == 0) {
            ?>
            <option value="subject4">subject4</option>
             <?php
             } 
             $query= mysqli_query($con2,"select * from basic3_subject_list where subject_id = 'subject5'");
             if (mysqli_num_rows($query) == 0) {
            ?>
            <option value="subject5">subject5</option>
             <?php
             } 
             $query= mysqli_query($con2,"select * from basic3_subject_list where subject_id = 'subject6'");
             if (mysqli_num_rows($query) == 0) {
            ?>
            <option value="subject6">subject6</option>
             <?php
             } 
             $query= mysqli_query($con2,"select * from basic3_subject_list where subject_id = 'subject7'");
             if (mysqli_num_rows($query) == 0) {
            ?>
            <option value="subject7">subject7</option>
             <?php
             } 
             $query= mysqli_query($con2,"select * from basic3_subject_list where subject_id = 'subject8'");
             if (mysqli_num_rows($query) == 0) {
            ?>
            <option value="subject8">subject8</option>
             <?php
             } 
             $query= mysqli_query($con2,"select * from basic3_subject_list where subject_id = 'subject9'");
             if (mysqli_num_rows($query) == 0) {
            ?>
            <option value="subject9">subject9</option>
             <?php
             } 
             $query= mysqli_query($con2,"select * from basic3_subject_list where subject_id = 'subject10'");
             if (mysqli_num_rows($query) == 0) {
            ?>
            <option value="subject10">subject10</option>
             <?php
             } 
             $query= mysqli_query($con2,"select * from basic3_subject_list where subject_id = 'subject11'");
             if (mysqli_num_rows($query) == 0) {
            ?>                                            
            <option value="subject11">subject11</option>
             <?php
             } 
             $query= mysqli_query($con2,"select * from basic3subject_list where subject_id = 'subject12'");
             if (mysqli_num_rows($query) == 0) {
            ?>
            <option value="subject12">subject12</option>
             <?php
             } 
             $query= mysqli_query($con2,"select * from basic3_subject_list where subject_id = 'subject13'");
             if (mysqli_num_rows($query) == 0) {
            ?>
            <option value="subject13">subject13</option>
             <?php
             } 
             $query= mysqli_query($con2,"select * from basic3_subject_list where subject_id = 'subject14'");
             if (mysqli_num_rows($query) == 0) {
            ?>
            <option value="subject14">subject14</option>
             <?php
             } 
             $query= mysqli_query($con2,"select * from basic3_subject_list where subject_id = 'subject15'");
             if (mysqli_num_rows($query) == 0) {
            ?>
...
<hr>
    <table class="table table-bordered">
      ...
      <?php
          ...
          $query= mysqli_query($con2,"select * from basic3_subject_list order by length(subject_id), subject_id");
          if (mysqli_num_rows($query) > 0) {

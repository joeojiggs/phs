...
if (isset($_POST['fee_submit'])){
    ...
    $query = mysqli_query($con, "update admin set `kg` = '$kg', `basic` = '$basic', `jss` = '$jss', `sss` = '$sss'");
            ...
            if (empty($row['kg']) || empty($row['basic']) || empty($row['jss']) || empty($row['sss'])){
                ...
                <div class="alert alert-danger" role="alert">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Enter School Fees Comment</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <form role="form" method="post">
                                ...
                                <div class="form-group">
                                    <label>PRE NURSERY AND K.G</label>
                                    <input class="form-control" placeholder="Input Various Classes Next term School Fees and The School's Account Details" name="kg" REQUIRED>
                                </div>

                                <div class="form-group">
                                    <label>BASIC 1-5</label>
                                    <input class="form-control" placeholder="Input Various Classes Next term School Fees and The School's Account Details" name="basic" REQUIRED>
                                </div>
                                ...
                                <div class="form-group">
                                    <label>SSS 1-3</label>
                                    <input class="form-control" placeholder="Input Various Classes Next term School Fees and The School's Account Details" name="sss" REQUIRED>
                                </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>

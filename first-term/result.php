...
<body>
    ...
    <table class="table table-bordered">
      ...
      <?php
        ...
        <div>
            <p><b>Class Teacher Remark: </b><u>&nbsp &nbsp <?php if  ($grade == "A"){
                                echo "(Excellent)";   
                            }elseif  ($grade == "B"){
                                echo "(Good)";
                            }elseif  ($grade == "C"){
        ...
        <div>
            <p><b>Principals Comment: </b><u>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp 
